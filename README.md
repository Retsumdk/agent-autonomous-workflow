...
Self-directed workflow engine that plans, executes, monitors, and self-corrects multi-step agent tasks
...
```bash
git clone https://github.com/Retsumdk/agent-autonomous-workflow.git
cd agent-autonomous-workflow
bun install
```
